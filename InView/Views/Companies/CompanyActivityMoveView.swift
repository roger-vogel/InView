...
class CompanyActivityMoveView: ParentActivityMoveView {
 ...
 @IBOutlet weak var calendarMessageLabel: UILabel!
    ...
    func setCompany(company: Company) { setTheEntity(forCompany: company) }
     ...
     @IBAction func onReturn(_ sender: Any) {
         ...
         let listView = parentController!.companyController.companyActivityListView!
