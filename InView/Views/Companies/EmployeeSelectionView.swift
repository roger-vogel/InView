...
class EmployeeSelectionView: ParentSelectionView {
    ...
    override func contactWasDeselected(contact: Contact) {
        ...
        theCompany!.removeFromEmployees(contact)
    ...
    @IBAction func onReturn(_ sender: Any) {
        ...
        parentController!.companyController.companyDetailsView.reloadEmployeeTable()
