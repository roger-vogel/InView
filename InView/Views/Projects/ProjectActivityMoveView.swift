...
class ProjectActivityMoveView: ParentActivityMoveView {
    ...
    func setCompany(company: Company) { setTheEntity(forCompany: company) }
     ...
     @IBAction func onReturn(_ sender: Any) {
         ...
         let listView = parentController!.projectController.projectActivityListView!
